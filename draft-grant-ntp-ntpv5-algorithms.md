...
NTPv5 implementations may use NTPv4 algorithms. Those supporting both versions of NTP may find it easy to include as a default or fall-back option in configurations where others are not set. All implementations both new and existing should also be mindful of the various algorithm specific verified errata.
